...
namespace SQLConnection
{
    public class Employee
    {
        ...
        public Employee(int Employee_Key_, int WWI_Employee_ID_, string Employee_, string Preferred_Name_, bool Is_Salesperson_, byte[] Photo_, DateTime Valid_From_, DateTime Valid_To_, int Lineage_Key_)
        {
            this.Employee_Key = Employee_Key_;
            this.WWI_Employee_ID = WWI_Employee_ID_;
            this.EmployeeName = Employee_;
